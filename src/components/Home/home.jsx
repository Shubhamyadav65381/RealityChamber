        ...
        <img src={cutout_building}
          ...
          <div className="relative w-full flex justify-center items-center h-[300px] md:h-[400px] lg:h-[500px]">
            ...
            <h1
              ...
              style={{ fontFamily: "'Playfair Display', serif", marginTop: "40px", marginLeft: "70px" }} // Use your imported font
            >
              REALTY
            </h1>
